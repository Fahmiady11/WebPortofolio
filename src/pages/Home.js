...
export default function Home() {
	...
	const mainImage = mode === "light" ? plane : rocket;
	...
	return (
		<>
			<div className="h-screen w-screen overflow-x-hidden">
				...
				<Navbar />
				<div className="flex gap-10 flex-col-reverse mt-10 md:mt-10 mb-28 sm:mb-0 items-center justify-end md:justify-around md:flex-row md:pl-10 h-full md:h-4/5">
					...
					<div className="max-w-xs md:max-w-md p-5">
